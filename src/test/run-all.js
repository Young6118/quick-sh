...
function showTestOptions() {
  ...
  console.log('  node src/test/run-all.js');
  console.log('');
  console.log('运行特定测试:');
  console.log('  node src/test/basic.test.js         # 基础功能测试');
  console.log('  node src/test/script-execution.test.js  # 脚本执行测试');
  console.log('  node src/test/alias.test.js         # 别名配置测试');
  console.log('  node src/test/error-handling.test.js    # 错误处理测试');
  console.log('  node src/test/config.test.js        # 配置管理测试');
  console.log('  node src/test/ai.test.js            # AI功能测试');
  console.log('');
  console.log('手动测试:');
